function[BM,FW,G]=BWGMAT(S,AL,RP,NFU,SN,CS)
...
%
G=zeros(3,8);
G(1,:)=[0 0 -C5 -C6 0 0 -C7 -C8];
G(2,:)=[0 CC*B1 FF*C1 FF*C2 0 CC*B2 FF*C3 FF*C4];
G(3,:)=[(FF*B1*0.5) (SS*B1*0.5+B3*0.5) 0 0 (FF*B2*0.5) (SS*B2*0.5+B4*0.5) 0 0];
